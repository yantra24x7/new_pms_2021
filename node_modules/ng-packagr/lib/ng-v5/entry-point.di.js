...
const downlevel_compilation_di_1 = require("./entry-point/ts/downlevel-compilation.di");
const remap_source_maps_di_1 = require("./entry-point/remap-source-maps.di");
...
exports.ENTRY_POINT_TRANSFORM = transform_di_1.provideTransform({
    ...
    deps: [
        ...
        downlevel_compilation_di_1.DOWNLEVEL_COMPILATION_TOKEN,
        write_bundles_di_1.WRITE_BUNDLES_TRANSFORM_TOKEN,
        remap_source_maps_di_1.REMAP_SOURCE_MAPS_TRANSFORM_TOKEN,
...
exports.ENTRY_POINT_PROVIDERS = [
    ...
    downlevel_compilation_di_1.DOWNLEVEL_COMPILATION_TRANSFORM,
    remap_source_maps_di_1.REMAP_SOURCE_MAPS_TRANSFORM,
